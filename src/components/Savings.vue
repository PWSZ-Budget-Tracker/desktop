                                    ...
                                    <v-container>
                                        <v-row>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.name" label="Oszczędności"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.amount" label="Cel"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.current" label="Aktualna kwota"></v-text-field>
                                            </v-col>
                                        </v-row>
                                    </v-container>
                                </v-card-text>
...
<script>
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nowa kategoria oszczędności' : 'Edytuj kategorie'
            },
        },
        ...
        methods: {
            ...
            deleteItem (item) {
                const index = this.savings.indexOf(item)
                confirm('Czy jesteś pewien, że chcesz usunąć tę kategorię?') && this.savings.splice(index, 1)
            },
